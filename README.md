...
#### SRC Boilerplate
- En esta clase el explico la estructura inicial de un proyecto hecho con CRA.

- En las clases antes de esta no se hizo nada en realidad del proyecto como tal.
...
- Things that we did in the class

-
1-) We change the title property in the HTML.

2-) We copied the font awesome link (who is orignally in the index.html inside of the proyect backroads-html) into the index.html of the backroaps-app.

3-) we justo copied the CSS and paste it inside the styles.css, remember to comment the photo on line 209.

4-) We copied the images folder into the assets folder in our project.

5-) Then copied the icons into the icons folder.

6-) We copied the HTML CODE and paste it in the App.jsx component -> modificamos el HTML.
-
...
- in this class we just set up the image for the Navbars
```js
// import
...
#### Smooth Scroll
- In this class he didnt do anything he just talked about how not always we need to use libraries, sometimes its ok to just use HTML and CSS.
- html/css feature
...
- Refactore the repeating li elements to a dynamic structure
```js
<li>
...
- add rel='noreferrer'
- here we did the same thing as with the page links (la clase anterior) just that we did with the social links instead of the page links.
